 package tw.edu.pu.gm.s1091756.aclass
...
import kotlinx.android.synthetic.main.activity_main.*
 ...
 class MainActivity : AppCompatActivity(),
     ...
     fun ShowPicture() {
         ...
         */
         ...
         when(PictureNo){
             ...
             1 -> txv.text = PictureNo.toString() + "大湖草莓"
             2 -> txv.text = PictureNo.toString() + "後龍路邊"
             3 -> txv.text = PictureNo.toString() + "阿嬤家門口"
             4 -> txv.text = PictureNo.toString() + "勝興車站"
             5 -> txv.text = PictureNo.toString() + "黃花風鈴木"
         }
         var res:Int = getResources().getIdentifier("img" + PictureNo.toString(),
     ...
     override fun onCreate(savedInstanceState: Bundle?) {
         ...
         while (res != 0) {
             countDrawables++;
             res = getResources().getIdentifier("img" + countDrawables.toString(),
                 "drawable", getPackageName());
         }
     ...
     override fun onLongPress(p0: MotionEvent?) {
         //txv.text = "長按"
         PictureNo = TotalPictures - 1 //第0張長按變成最後一張
         ShowPicture()
     }
